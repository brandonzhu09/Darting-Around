                ...
                <div class="flex-wrap">
                    {props.trips.map(trip => (
                        <div class="flex px-4 py-4">
                            <img class="object-contain mr-4" src={trip.airlineLogo === "" ? airline_logo : trip.airlineLogo} />
                            <div class="mr-4 mb-4">
                                <h1>{trip.departureTime} - {trip.arrivalTime}</h1>
                            ...
                            <div>
                                {trip.stops === 0 ? (
                                    ...
                                    <h1>{trip.duration} ({trip.stops} stops)</h1>}
                                <h3 class="flex text-sm font-thin">{trip.originLocationCode} - {trip.destinationLocationCode}</h3>
                            </div>
                        </div> 
                    ))}
